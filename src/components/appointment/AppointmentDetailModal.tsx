...
export function AppointmentDetailModal({ open, onClose, appointment, fullScreen }: AppointmentDetailModalProps) {
        ...
        <div className="px-4 py-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="text-sm text-gray-900">{view.createdAt ? new Date(view.createdAt).toLocaleString() : '-' }</div>
            </div>
            <div>
              <div className="text-xs text-gray-500">Cập nhật</div>
              <div className="text-sm text-gray-900">{view.updatedAt ? new Date(view.updatedAt).toLocaleString() : '-'}</div>
            </div>
          </div>
